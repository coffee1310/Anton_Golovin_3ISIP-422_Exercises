...
class Person0 {
    ...
    public Person0(String name, int age, String gender) {
        this.name = name;
        this.age = age;
        this.gender = gender;
    }
...
public class Main {
    public static void main(String[] args) {
        ...
        switch (change) {
            case 1:
                Person0 person = new Person0("Иван", 30, "Мужчина");
                ...
                break;
            case 2:
                Worker worker1 = new Worker("Иван", "Иванов", 50000);
                Worker worker2 = new Worker("Петр", "Петров", 55000);
                Worker worker3 = new Worker("Сергей", "Сергеев", 52000);
                ...
                Manager manager = new Manager("Анна", "Смирнова", 100000, workers);

                System.out.println("Менеджер: " + manager.getFirstName() + " " + manager.getSecondName());
                System.out.println("Зарплата менеджера: " + manager.getSalary());

                System.out.println("\nПодчиненные менеджера:");
                for (Worker worker : workers) {
                    System.out.println("- " + worker.getFirstName() + " " + worker.getSecondName() + ", Зарплата: " + worker.getSalary());
                }
                break;
            case 3:
